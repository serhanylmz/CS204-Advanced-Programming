...
#ifdef _DEBUG
    cout << "In main, m1_num_rows = " << m1_rows << " and m1_num_columns = " << m1_cols << endl;
#endif
    structure_is_okay(m1, m1_rows, m1_cols);

    row_node* m2 = read_matrix(filename2, m2_rows, m2_cols);
#ifdef _DEBUG
    cout << "In main, m2_num_rows = " << m2_rows << " and m2_num_columns = " << m2_cols << endl;
#endif
